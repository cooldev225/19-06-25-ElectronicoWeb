<div class="content-wrapper">
    <section class="content-header">
      <h1>
        <?php echo "<font stype='font-weight:bold;'>".$_user_location."</font>";?> Extra Homework Template
      </h1>
				...
				<div class="col-sm-6">
					<div class="box">
						<div class="box-header">
						  <h3 class="box-title">EXTRA HOMEWORK MESSAGE TEMPLATE
						  ...
						  <div class="pull-right box-tools">
							...
							<button type="button" onclick="saveAction(8);" data-toggle="modal" class="btn btn-block btn-primary " data-target="#modal-success">SAVE</button>
							</div>
						</div>
						<!-- /.box-header -->
						...
						<div class="box-body pad">
						  <form>
							<textarea id="body" class="textarea" placeholder="Place some text here" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php
								if(!isset($templatedata[8]['textx']))echo "There is no data.";
								else echo $templatedata[8]['textx'];
							?>
							</textarea>
						  </form>
						</div>
                ...
                <div class="col-sm-6" style="border-left: 1px dashed #d6d8d8;" id="previewpanel">
					  ...
					  <div class="small-box bg-primary">
						...
						<div id="preview" style="min-height:420px;">
							<p><?php if(!isset($templatedata[8]['textx']))echo "There is no data.";
								else echo str_replace("\n","<br>",$templatedata[8]['textx']);?></p>
						</div>
