...
<body class="hold-transition login-page">
    ...
    <form action="<?php echo base_url('login/signin');?>" method="post">
      <div class="form-group has-feedback">
        <input id="usernameoremail" name="usernameoremail" type="text" class="form-control" placeholder="Username or Email">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" id="passeord" name="password" class="form-control" placeholder="Password">
